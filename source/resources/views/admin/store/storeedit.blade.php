                    ...
                    <div class="row">
                     ...
                     @if($mapset->mapbox == 1 && $mapset->google_map == 0) 
                      <div class="row">                    
                            <div class="col-md-12">
                           <div class="form-group">
                            <label for="autocomplete"> Vendor Address </label>
                  	...
                  	<div class="row">
                    	<div class="col-md-6">
                           ...
                           <label for="lat">Latitude</label>
								<input id="lat" type="text" name="lat" class="form-control" value="{{$store->lat}}" required>
                        	</div>
                    	</div>
                    	<div class="col-md-6">
                           <div class="form-group">
                           <label for="lng">Longitude</label>
								<input id="lng" type="text" name="lng" class="form-control" value="{{$store->lng}}" required>
                        	</div>
                    	</div>
                  	</div>
