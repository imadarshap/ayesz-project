                ...
                <div class="card-body">
                  <form class="forms-sample" action="{{route('storeadd')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Vendor Number</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="number" name="share" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="range" class="form-control" placeholder="Delivery Range in KM" required>
                        </div>
                      </div>
                    </div><br>
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     ...
                     @if($mapset->mapbox == 1 && $mapset->google_map == 0) 
                      <div class="row">                    
                       ...
                       <div class="autocomplete" style="width:100%;">
                            <input id="myInput" type="text" name="address" placeholder="address" required>
					...
					<div class="row">
                    	<div class="col-md-6">
                           ...
                           <label for="lat">Latitude</label>
								<input id="lat" type="number" min="0" step="any" name="lat" class="form-control" required>
                        	</div>
                    	</div>
                    	<div class="col-md-6">
                           <div class="form-group">
                           <label for="lng">Longitude</label>
								<input id="lng" type="text"  min="0" step="any" name="lng" class="form-control" required>
                        	</div>
                    	</div>
                  	</div>
...
{{-- javascript code --}}
<script src="//maps.googleapis.com/maps/api/js?key={{$map}}&libraries=places" type="text/javascript"></script>
<script>
