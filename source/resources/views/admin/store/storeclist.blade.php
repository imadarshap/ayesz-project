...
<div class="col-lg-12">  
     <a href="{{route('store')}}" class="btn btn-primary ml-auto" style="width:10%;float:right;padding: 3px 0px 3px 0px;"><i class="material-icons">add</i>Add Vendor </a>
</div>     
<div class="col-lg-12">
<div class="card">    
