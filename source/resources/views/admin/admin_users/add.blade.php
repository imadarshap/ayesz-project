  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <form class="forms-sample" action="{{route('admin_users.store')}}" method="post" autocomplete="off">
          {{csrf_field()}}
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="admin_email" class="form-control" autocomplete="off" required>
                </div>
                <div class="form-group">
                  ...
                  <tbody>
                    @foreach($modules as $module)
                      <tr>
                        <th>{{$module['title']}}</th>
                        <td>
                          <input type="checkbox" class="check_all" name="all_{{$module['module']}}" value="All"/>
                        </td>
                        <td>
                        @if(strpos($module['rights'],'View') !== false )
                        <input type="checkbox" class="check" name="{{$module['module']}}[]" value="View"/>
                        @else
                        -
                        @endif
                        </td>
                        ...
                        <input type="checkbox" class="check" name="{{$module['module']}}[]" value="Add"/>
                        @else
                        -
                        @endif
                        </td>
                        ...
                        <input type="checkbox" class="check" name="{{$module['module']}}[]" value="Edit"/>
                        @else
                        -
                        @endif
                        </td>
                        ...
                        <input type="checkbox" class="check" name="{{$module['module']}}[]" value="Delete"/>
                        @else
                        -
                        @endif
                        </td>
