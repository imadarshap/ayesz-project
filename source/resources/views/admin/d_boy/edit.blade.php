              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Delivery Agent Name</label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Delivery Agent Phone</label>
                    ...
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                            <div class="col-md-6">
                           <div class="form-group">
                            <label for="autocomplete"> Delivery Agent Address </label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="status" class="form-control">
                              <option value="1" @if($d_boy->status==1)selected @endif>On Duty</option>
                          		<option value="0" @if($d_boy->status==0)selected @endif>Off Duty</option>
