...
<div class="col-lg-12">  
     <a href="{{route('AddD_boy')}}" class="btn btn-primary ml-auto" style="width:15%;float:right;padding: 3px 0px 3px 0px;"><i class="material-icons">add</i>Add Delivery Agent</a>
</div> 
<div class="col-lg-12">
<div class="card">    
<div class="card-header card-header-primary">
      <h4 class="card-title" style="width:50%;float:left;">Delivery Agent List</h4>
    </div>
