			    ...
			    <div class="container">
			        <div class="row justify-content-center">
			            <div class="col-12">
			                ...
			                <h2 class="">Join AyesZ</h2>
			                <p class="">If you thrive on out of the box thinking and relentless pursuit of excellence, we would love to meet you.</p>
			                <p>See a position you’d like? Please apply. New positions are constantly opening up.</p>
			                <div class="mt-4">
			                    <h3>About ayesz</h3>
			                    <p>AyesZ was founded in September 2020 in Proddatur by a team of four – T.Venkata Prasad,L.Sudarshana   Reddy,   D.   Mahesh,   B.   Sudheer   Kumar.   Servicing   over   5   million   registeredcustomers; ayesz has grown into India's largest online supermarket with over 20,000 productsfrom over 1000 brands and presence in 26 cities across the country including Proddatur, Kadapa,Hyderabad, Vijayawada, Rajahmundry, Tirupati & Kurnool. ayesz's online store offers a varietyof products across various categories: Fresh Fruits & Vegetables, Grocery & Staples, Beverages,Bread, Dairy & Egg products, Branded Foods, Meat, Personal Care and Household products.ayesz is committed to making life simpler and grocery shopping a breeze!</p>
			                </div>
			                <div class="mt-4">
			                    
			                    <h3>Why should you join ayesz?</h3>
			                    <p>ayesz thrives on out of the box thinking and relentless pursuit of excellence. We are looking forpeople who share our passion for building world class product. If you are excited about theprospect of changing the way India shops for groceries and being a pioneer -- then this a greathome for you. Not to mention the thrill of building products that millions use on a daily basis andusing cutting edge technology to make the products customers love.</p>
			                    <p>We  pride ourselves  in solving customer  problems  in the  most efficient  and elegant  ways.Everything we do is guided by our core culture and values.</p>
			                </div>
			            </div>
			        </div>
			    </div>
