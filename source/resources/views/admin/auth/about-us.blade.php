             ...
             <!-- ============================================================== -->
		        ...
		        <div id="main-wrapper">
					...
					<section style="padding-top:0px;">
					    <div class="bg-cover" style="background:#eff8e7 url(assets/img/gro-trans.) no-repeat;padding:30px 0px;">
    					    <div class="container">
    					        <div class="row justify-content-center">
    					            <div class="col-12 text-center">
    					                <h1 class="mb-4">About Us</h1>
    					                <h3 class="grocery_title">What is Ayesz.in</h3>
    					                <p>Ayesz.in (AyesZ Private Limited) is India’s largest online food and grocery store. With over20,000 products and over 1000 brands in our catalogue you will find everything you arelooking for. Right from fresh Fruits and Vegetables, Rice and Dals, Spices and Seasonings toPackaged   products,   Beverages,   Personal   care   products,   Meats   –   we   have   it   all.Choose from a wide range of options in every category, exclusively handpicked to help youfind the best quality available at the lowest prices. Select a time slot for delivery and yourorder will be delivered right to your doorstep, anywhere in Proddatur and Later in Kadapa,Tirupati,   Kurnool,   Anantapur,   Tenali,   Rajahmundry,Nellore,   Hyderabad,   Vijayawada-Guntur, Visakhapatnam and not only limited to these cities, you can pay online using yourdebit / credit/ Net banking/ Through our AyesZ Wallet card or by cash / UPI on delivery.</p>
    					            </div>
    					        </div>
    					    </div>
    					 </div>
					  <div class="container" style="padding:30px 0px;">
					      <div class="row mt-4">
					          <div class="text-center col-12">
			        		    <span class="theme-cl">We guarantee on time delivery, and the best quality!</span>
			        		    <h2 class="mb-3 mt-3">Happy Shopping</h2>
			        		</div>
					      </div>
					        <div class="row mt-4">
					        	<div class="col-12 col-md-6">
					        		
					        		<h3>Why should I use ayesz.in?</h3>
					        		<p>Ayesz.in allows you to walk away from the drudgery of grocery shopping and welcome an easy relaxed way of browsing and shopping for groceries. Discover new products and shop for all your food and grocery needs from the comfort of your home or office. No more getting stuck in traffic jams, paying for parking, standing in long queues and carrying heavy bags – get everything you need, when you need, right at your doorstep. Food shopping online is now easy as every product on your monthly shopping list, is now available online at ayesz.in, India’s best online grocery store.</p>
					        	</div>
					        	<div class="col-12 col-md-6">
					        		<div class="justy_centre_dv">
					        			<img src="{{url('assets/assets/img/ab1.png')}}">
					        		</div>
					        	</div>
					        </div>
					        <div class="row mt-3">
								  ...
								  <div id="accordion" class="mt-3">
								    <div class="card mb-3">
								      <div class="card-header">
								        <a class="card-link" data-toggle="collapse" href="#collapseOne">
								          Browse ayesz.in for products or use the search feature
								        </a>
								      </div>
								      <div id="collapseOne" class="collapse show" data-parent="#accordion">
								        <div class="card-body">
								         	<img src="{{url('assets/assets/img/2.png')}}">
								        </div>
								      </div>
								    </div>
								    <div class="card mb-3">
								      ...
								      <div id="collapseTwo" class="collapse" data-parent="#accordion">
								        <div class="card-body">
								          <img src="{{url('assets/assets/img/1.png')}}">
								        </div>
								      </div>
								    </div>
								    <div class="card mb-3">
								      <div class="card-header">
								        <a class="collapsed card-link" data-toggle="collapse" href="#collapseThree">
								         Select suitable payment option (Cash, Net banking, Credit Card)
								      ...
								      <div id="collapseThree" class="collapse" data-parent="#accordion">
								        <div class="card-body">
								         <ul class="accordion_ul">
								         	<li><p>1. Cash on Delivery</p></li>
											<li><p>2. Cards (Here mentioned images of Master card, visa card like)</p></li>
											<li><p>3. Coupons</p></li>
								         </ul>
								        </div>
								      </div>
								    ...
								    <div class="card mb-3">
								      ...
								      <div id="collapseFour" class="collapse" data-parent="#accordion">
								        <div class="card-body">
								         <img src="{{url('assets/assets/img/3.png')}}">
								        </div>
								      </div>
								    </div>
								    <div class="card mb-3">
								      ...
								      <div id="collapseFive" class="collapse" data-parent="#accordion">
								        <div class="card-body">
								         <p>We currently offer our services in Proddatur and Later in Kadapa, Tirupati, Kurnool, Anantapur, Tenali, Rajahmundry, Nellore, Hyderabad,Vijayawada-Guntur,Visakhapatnam city limits.</p>
								        </div>
								      </div>
								    </div>
								  </div>
