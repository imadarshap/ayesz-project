          ...
          <form>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="max_cart_value" class="form-control">
                </div>
              </div>
            </div><br>
            <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="coupon_discount" name="coupon_discount" placeholder="Enter discount"/>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
