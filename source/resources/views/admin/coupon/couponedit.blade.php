        ...
        <div class="card-body">
          <form>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <p class="card-description">Maximum Cart Value</p>
                  <input type="number" value="{{$coupon->max_cart_value}}" name="max_cart_value" class="form-control">
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleFormControlSelect3">Discount Type</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <label class="coupon_discount">Discount</label>
                  <input type="number" class="form-control" value="{{$coupon->amount}}" id="coupon_discount" name="coupon_discount" placeholder="Enter discount"/>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="bmd-label-floating">Maximum Discount</label>
                  <input type="number" class="form-control" value="{{$coupon->max_discount}}" id="max_discount" name="max_discount"/>
                </div>
              </div>
            </div>
