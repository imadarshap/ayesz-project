          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="td-actions">
                ...
                <a href="{{route('store_confirm_order', $order->cart_id)}}" onclick="if(!confirm('Are you sure, you want to confirm this order'))return false;" rel="tooltip" class="btn btn-success">
                  Confirm/Assign
                </a>
                <a href="{{route('store_reject_order' , $order->cart_id)}}" onclick="if(!confirm('Are you sure, you want to reject this order'))return false;" rel="tooltip" class="btn btn-danger">
                  Reject
                </a>
