...
<div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="nav-item {{ (request()->is('store/orders/all')) ? 'active' : '' }} {{ (request()->is('store/orders/today')) ? 'active' : '' }} {{ (request()->is('store/orders/next_day')) ? 'active' : '' }}">
        ...
        <div class="collapse {{ (request()->is('store/orders/today')) ? 'show' : '' }} {{ (request()->is('store/orders/next_day')) ? 'show' : '' }}" id="setting-dropdown2">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('store/orders/all')) ? 'activate' : '' }}" href="{{route('storeAllOrders')}}">All Orders</a>
            </li>
