      ...
      ///////what's new//////
       ...
       //top six categories//
        Route::post('topsix', 'CategoryController@top_six');
         ...
         //Delivery fee info////
        Route::post('delivery_info', 'OrderController@delivery_info');
...
Route::group(['prefix'=>'store', ['middleware' => ['XSS']], 'namespace'=>'Storeapi'], function(){
    ...
    Route::post('store_stock_price_update', 'AddproductController@stock_price_update');
	Route::post('get_product_detail', 'AddproductController@get_product_detail');
  ...
  Route::post('confirm_order','AssignController@confirm_order');
...
Route::group(['prefix'=>'driver', ['middleware' => ['XSS']], 'namespace'=>'Driverapi'], function(){
	...
	Route::post('deliveryorders', 'DriverorderController@deliveryorders');
	...
	Route::post('accept_order', 'DriverorderController@accept_order');
