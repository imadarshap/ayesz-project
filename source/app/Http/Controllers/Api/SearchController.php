...
class SearchController extends Controller
{
    ...
    $stores = DB::table('store')->select('store.store_id','store_name','product.product_name','product.product_id','product_varient.varient_id','product_varient.quantity',
                                         'product_varient.unit','product_varient.varient_image','product_varient.description','product.cat_id',
    ...
    $message = array('status'=>'1', 'message'=>'Products found', 'data'=>$stores);
            return $message;
